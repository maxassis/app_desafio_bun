...
import React, { useState, useEffect, useRef, useMemo } from "react";
import { View, ActivityIndicator, TouchableOpacity, Image, StatusBar, Text, FlatList } from "react-native";
import { Image as ExpoImage } from "expo-image";
...
export default function Map2() {
  ...
  return (
    <View className="flex-1 bg-white justify-center items-center relative">
      ...
      {/* Botões */}
      <TouchableOpacity onPress={() => router.push("/dashboard")} className="absolute top-[38px] left-[13px] h-[43px] w-[43px] rounded-full bg-bondis-text-gray justify-center items-center">
        <Left />
      </TouchableOpacity>

      <TouchableOpacity onPress={toggleMapType} className="absolute top-[38px] right-[13px] h-[43px] w-[43px] rounded-full bg-bondis-text-gray justify-center items-center px-3">
        <Octicons name="stack" size={16} color="black" />
      </TouchableOpacity>
